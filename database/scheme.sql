...
CREATE DATABASE IF NOT EXISTS `onoxfri` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `onoxfri`;
...
(1, 'Admin', 'admin@example.com', '$2y$10$eImiTXuWVxfM37uY4JANjQ==', 1, '2025-10-04 20:47:05', NULL),
(2, 'Gerente Demo', 'gerente@example.com', '$2y$10$eImiTXuWVxfM37uY4JANjQ==', 1, '2025-10-04 20:47:05', NULL),
(3, 'Asistente Demo', 'asistente@example.com', '$2y$10$eImiTXuWVxfM37uY4JANjQ==', 1, '2025-10-04 20:47:05', NULL)
ON DUPLICATE KEY UPDATE
  name = VALUES(name),
  is_active = VALUES(is_active);
...
(2, 2, '2025-10-04 20:47:05'),
(3, 3, '2025-10-04 20:47:05')
ON DUPLICATE KEY UPDATE
...
ALTER TABLE `empresas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_empresas_usuario` (`usuario_id`);
...
--
ALTER TABLE `empresas`
  ADD CONSTRAINT `fk_empresas_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
/* Empresa por defecto (si ya existe no duplica) */
INSERT INTO empresas (id, nombre_empresa, descripcion, usuario_id, fecha_creacion)
VALUES (1, 'Empresa por defecto', 'Empresa de trabajo e inventario', 1, NOW())
ON DUPLICATE KEY UPDATE nombre_empresa = VALUES(nombre_empresa);

/* Añadir columna company_id y FK a tablas principales */
ALTER TABLE categories
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_categories_company (company_id),
  ADD CONSTRAINT fk_categories_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE products
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER updated_at,
  ADD INDEX idx_products_company (company_id),
  ADD CONSTRAINT fk_products_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE stock_levels
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER updated_at,
  ADD INDEX idx_stock_company (company_id),
  ADD CONSTRAINT fk_stock_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE inventory_movements
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_by,
  ADD INDEX idx_movements_company (company_id),
  ADD CONSTRAINT fk_movements_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE suppliers
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_suppliers_company (company_id),
  ADD CONSTRAINT fk_suppliers_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE customers
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_customers_company (company_id),
  ADD CONSTRAINT fk_customers_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE promotions
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_promotions_company (company_id),
  ADD CONSTRAINT fk_promotions_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE import_jobs
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_by,
  ADD INDEX idx_imports_company (company_id),
  ADD CONSTRAINT fk_imports_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE custom_transactions
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_custom_tx_company (company_id),
  ADD CONSTRAINT fk_custom_tx_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE price_history
  ADD COLUMN company_id BIGINT UNSIGNED NOT NULL DEFAULT 1 AFTER created_at,
  ADD INDEX idx_price_history_company (company_id),
  ADD CONSTRAINT fk_price_history_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE audit_logs
  ADD COLUMN company_id BIGINT UNSIGNED DEFAULT 1 AFTER user_id,
  ADD INDEX idx_audit_company (company_id),
  ADD CONSTRAINT fk_audit_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE backups
  ADD COLUMN company_id BIGINT UNSIGNED DEFAULT 1 AFTER created_by,
  ADD INDEX idx_backups_company (company_id),
  ADD CONSTRAINT fk_backups_company FOREIGN KEY (company_id) REFERENCES empresas(id) ON DELETE SET NULL ON UPDATE CASCADE;
