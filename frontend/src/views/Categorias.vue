    ...
    <main class="page">
      ...
      <section class="kpis">
        ...
        <div class="kpi">
          ...
          <div class="kpi-value" style="font-size: 1.2rem;">{{ stats.masUsada }}</div>
        </div>
      </section>
      ...
      <section class="table-section">
        <div class="card">
          <div class="card-header">
            <h3><i class="bi bi-table"></i> Lista de Categorías</h3>
              ...
              <table class="products-table">
                ...
                <tbody>
                  ...
                  <tr v-for="categoria in filteredCategorias" :key="categoria.id">
                    ...
                    <td>
                      <span class="stock">{{ categoria.productos }}</span>
                    </td>
                    <td>
                    ...
                    <td class="actions">
                      <button class="btn-icon edit" @click="openModal(categoria)" title="Editar">
                        <i class="bi bi-pencil"></i>
                      </button>
                      <button class="btn-icon delete" @click="confirmDelete(categoria)" title="Eliminar">
...
const MobileCategorias = defineAsyncComponent(() => import('./mobile/Categorias.vue'))

const router = useRouter()

const isMobile = ref(window.innerWidth <= 992)
const currentComponent = computed(() => isMobile.value ? MobileCategorias : null)
