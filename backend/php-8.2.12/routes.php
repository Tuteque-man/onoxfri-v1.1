...
$GET_ROUTES = [
    ...
    '/empresas' => [
        'action' => ['EmpresasController', 'getAll'],
        'middlewares' => [
            ['JsonMiddleware'],
            ['AuthMiddleware']
        ]
    ...
    '/empresas/my' => [
        'action' => ['EmpresasController', 'getMine'],
        'middlewares' => [
            ['JsonMiddleware'],
            ['AuthMiddleware']
        ]
...
$POST_ROUTES = [
    ...
    '/empresas/create' => [
        'action' => ['EmpresasController', 'create'],
        'middlewares' => [
            ['JsonMiddleware'],
            ['AuthMiddleware']
        ]
    ...
    '/empresas/update' => [
        'action' => ['EmpresasController', 'update'],
        'middlewares' => [
            ['JsonMiddleware'],
            ['AuthMiddleware']
        ]
    ...
    '/empresas/delete' => [
        'action' => ['EmpresasController', 'delete'],
        'middlewares' => [
            ['JsonMiddleware'],
            ['AuthMiddleware']
        ]
